...
# AudioReach topology source for the AYN Odin3 (SM8750).
#
# Build with the macro library from
# https://git.codelinaro.org/linaro/qcomlt/audioreach-topology:
#
#   m4 -I <audioreach-topology> SM8750-AYN.m4 > SM8750-AYN.conf
...
#
# The KONKR file is the same topology with the I2S data line on SD1.
...
dnl Speaker amps: 2x AW88166 on SECONDARY MI2S, data0 = SD0.
